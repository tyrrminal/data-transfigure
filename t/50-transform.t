...
like(dies {Data::Transfigure->bare->add_transfigurators('NonexistentClass')}, qr/^\Q$msg/, 'attempt to register non-existent class');
...
like(dies {$t->transfigure({ person => bless({firstname => 'Bob'}, 'MyApp::Person') })}, qr/^Deep recursion detected in Data::Transfigure::transfigure/, 'catch unbounded recursion');
